...
module.exports = function(grunt) {
  ...
  var mandantenConfig = {
    mandant1: {
      API_URL: API_URL_CONFIG[env].m1 || "http://localhost:9003/m1/", //replace @@API_URL with value
      API_WS_URL:
        API_URL_CONFIG[env].m1 + "ws" || "http://localhost:9003/m1/ws", //replace @@API_WS_URL with value
      BUILD_NR: grunt.option("buildnr") || "dev",
      ENV: env,
      VERSION: grunt.file.readJSON("package.json").version
    },
    mandant2: {
      ...
      API_WS_URL:
        API_URL_CONFIG[env].m2 + "ws" || "http://localhost:9003/m2/ws", //replace @@API_WS_URL with value
      BUILD_NR: grunt.option("buildnr") || "dev",
      ENV: env,
      VERSION: grunt.file.readJSON("package.json").version
    }
