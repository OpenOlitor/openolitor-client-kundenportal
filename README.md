...
## bumpversion.sh
Mittels `./bumpversion.sh` (`./bumpversion.sh -v 1.0.x`) wird die Version im `package.json` dieses Projekts erhöht.
...
Dieses Projekt verwendet npm für die Verwaltung von Abhängigkeiten (migriert von Bower).
Siehe `MIGRATION_NOTES.md` für Details zur Migration.
